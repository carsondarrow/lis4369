...
setwd("/Users/carsondarrow/repos/lis4369/a5/r_tutorial")

pdf(file="/Users/carsondarrow/repos/lis4369/a5/r_tutorial/myplotfile.pdf")
...
barplot(BOD$demand, main="graph of demand", names.org = BOD$time)
